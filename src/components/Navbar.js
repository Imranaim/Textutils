...
export default function Navbar(props) {
  ...
  <div className="container-fluid">
    <Link  ink className="navbar-brand" to="/">{props.title}</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className={`form-check form-switch mx-2 text-${props.mode === 'light' ? 'dark':'light'} text-${props.id === 'Dark' ? 'dark':'light'}`}>
